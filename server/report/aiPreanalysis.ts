...
const PROMPT_HEADER = [
  ...
  "  • SCANNER / ANGIO-CT (Dr Eva Son) : section nommée 'Résultats' avec régions en MAJUSCULES + deux-points (ex. « RACHIS LOMBAIRE : [...] ÉPAULE DROITE : [...] ») + Conclusion en PROSE avec findings-clés en **gras**.",
...
export function modalityBlock(modality?: string): string {
  ...
  if (m === "CT")
    return [
      ...
      "IMPORTANT : dans ta réponse, la section des constatations RESTE nommée « Résultats: » (PAS « Description: »).",
      "- Section 'Résultats' : chaque RÉGION ANATOMIQUE est introduite par son nom EN MAJUSCULES suivi d'un espace et d'un deux-points, puis prose libre sur la même ligne ou les suivantes.",
      "  • Exemple SCANNER MULTI-RÉGION (trauma) : « RACHIS LOMBAIRE : Signes d'arthrose postérieure étagée L3-L4 et L4-L5... ÉPAULE DROITE : L'examen de l'épaule droite est dans la norme... GENOU DROIT : Absence de lésion osseuse d'allure traumatique... ABDOMEN ET PELVIS : Les organes pleins présentent une morphologie et une densité normales... BASSIN ET HANCHES : L'anneau pelvien est intègre... »",
      "  • ANGIO-SCANNER VASCULAIRE : axes artériels (perméabilité, sténose % NASCET, plaques, occlusion, dissection) → territoire intracrânien → parenchyme cérébral → sinus/rochers → parties molles. Régions : AXES CAROTIDIENS ET VERTÉBRAUX :, TERRITOIRE INTRACRÂNIEN :, PARENCHYME CÉRÉBRAL :.",
      ...
      "  • Formules normales ostéo-articulaires : « Absence de trait de fracture ou de tassement vertébral récent. Le calibre du canal rachidien est respecté. Absence de fracture, de luxation ou d'anomalie de la ceinture scapulaire. Absence d'épanchement intra-articulaire (hydarthrose). Les organes pleins présentent une morphologie et une densité normales pour un examen non injecté. »",
      "- Section 'Conclusion' : PROSE (PAS de liste numérotée) — 2 à 4 phrases. Les findings pathologiques sont mis en **gras** (ex. « **Arthrose postérieure inflammatoire étagée du rachis lombaire (L3-L4, L4-L5).** »). Les constats négatifs importants sont cités explicitement. Recommandation corrélative si pertinente.",
      "  • Exemple : « Absence de lésion traumatique osseuse aiguë au niveau de l'épaule droite, du genou droit, du bassin ou du rachis. **Arthrose postérieure inflammatoire étagée du rachis lombaire (L3-L4, L4-L5), avec une atteinte prédominante en L5-S1.** Absence de lésion traumatique viscérale abdomino-pelvienne décelable sur cet examen natif. »",
      "- TECHNIQUE CT CHAMPEL : « Acquisition hélicoïdale multi-barrettes réalisée [sans injection de produit de contraste (examen natif) / après injection intraveineuse de X ml d'Iomeron 350, lot XXXXXX] sur scanner Toshiba 128 barrettes Aquilion CX. Reconstructions multiplanaires en filtres dur et mou. »",
