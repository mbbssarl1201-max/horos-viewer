...
const PROMPT_HEADER = [
  ...
  "",
  "Style de rédaction (compte rendu radiologique professionnel) :",
  "- CONCIS et TÉLÉGRAPHIQUE : phrases courtes et factuelles, comme un vrai compte rendu. PAS de remplissage, PAS de phrases d'introduction, PAS de répétition des mêmes formules de prudence (« à corréler à la clinique » : au plus UNE fois, dans la Conclusion).",
  "- TERMINOLOGIE radiologique standard et précise (descriptifs anatomiques exacts ; classifications BI-RADS / EU-TIRADS / Fleischner / LI-RADS quand elles s'appliquent).",
  "- Dans RÉSULTATS, structure PAR ORGANE / RÉGION : une ligne par structure, préfixée de son nom suivi de deux-points (ex. « Foie : … », « Reins : … », « Structures osseuses : … »), dans un ordre anatomique logique. En analyse multi-séries, regroupe par série/région. Mentionne explicitement le NORMAL pour les structures pertinentes (ne liste pas que les anomalies).",
  "- CONCLUSION : 1 à 3 lignes de synthèse, hiérarchisées (anomalie principale d'abord). Pas de paraphrase des Résultats.",
  "",
  "Méthode :",
...
const PROMPT_FOOTER = [
  ...
  "",
  "Résultats:",
  "<UNE LIGNE PAR ORGANE/STRUCTURE, préfixée de son nom + deux-points (« Foie : … »), en ordre anatomique, concis ; en multi-séries, regroupe par série/région>",
  "",
  "Conclusion:",
  "<synthèse hiérarchisée, 1 à 3 lignes, hypothèses à confirmer>",
  "",
  "Anomalie:",
