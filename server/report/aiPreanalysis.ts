...
export function modalityBlock(modality?: string): string {
  ...
  if (m === "CT")
    return [
      ...
      "VARIANTE A — CT STANDARD (focal, régional, usage habituel) : nomme la section « Description: ».",
      "  Structure : paragraphes commençant par « Au niveau [région], ... ».",
      ...
      "SECTION CONCLUSION (toutes variantes) :",
      "  Examen NORMAL → une seule phrase courte. Ex. : « Examen dans les limites de la norme sans lésion traumatique. »",
      "  Examen PATHOLOGIQUE → une phrase courte PAR FINDING, chacune en **gras** sur sa propre ligne. Ordre : pathologie > absences significatives. Ex. : « **Syndesmophyte récessal gauche L5-S1 avec probable hernie discale calcifiée ancienne au contact de la racine S1 gauche.**\\n**Remaniements interfacetaires inflammatoires L3-L4 bilatéraux.**\\n**Absence de lésion traumatique aiguë.** »",
