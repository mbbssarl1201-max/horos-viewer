...
const PROMPT_HEADER = [
  ...
  "7. GRADE les lésions quand une classification existe (Meyerding pour l'antélisthésis/spondylolisthésis, Outerbridge pour la chondropathie, BI-RADS, EU-TIRADS, Fleischner, LI-RADS, Bosniak…).",
  ...
  "",
  "Style de rédaction (compte rendu radiologique professionnel — Institut Médical de Champel) :",
  "- CONCIS et TÉLÉGRAPHIQUE : phrases courtes et factuelles. PAS de remplissage, PAS de phrases d'introduction, PAS de répétition des formules de prudence (« à corréler à la clinique » : au plus UNE fois en Conclusion).",
  "- TERMINOLOGIE radiologique standard et précise (classifications BI-RADS / EU-TIRADS / Fleischner / LI-RADS quand elles s'appliquent).",
  "- Dans RÉSULTATS, structure PAR ORGANE / RÉGION avec UNE PUCE BULLET et une ÉTIQUETTE EN GRAS pour chaque sous-section, format EXACT : « • **Étiquette :** description. » (ex. « • **Foie :** taille normale, échostructure homogène. », « • **Analyse focale :** absence de masse. », « • **Analyse axillaire :** absence d'adénopathie suspecte. »). Mentionne explicitement le NORMAL pour les structures pertinentes.",
  "- CONCLUSION : 2 à 3 phrases DIRECTES et DÉCISIVES sur des lignes séparées. Première ligne = bilan global (ex. « Examen échographique normal. »). Deuxième ligne = réponse à l'indication / malignité (ex. « Absence de signe de malignité sur les clichés du jour. »). PAS de paraphrase des Résultats.",
  "- CLASSIFICATION : si une classification validée s'applique (BI-RADS pour sein/mammographie, EU-TIRADS pour thyroïde, LI-RADS pour foie, Bosniak pour rein…), l'indiquer EN GRAS sur une ligne dédiée juste après la Conclusion (ex. « **Classification : BI-RADS 1** »).",
  "",
  "Méthode :",
...
const PROMPT_FOOTER = [
  ...
  "",
  "Résultats:",
  "• **Organe/Région :** description concise.",
  "• **Autre structure :** description concise.",
  "<une puce par organe/région, étiquette en gras + deux-points, ordre anatomique ; en multi-séries, regroupe par série/région>",
  "",
  "Conclusion:",
  "<2 à 3 phrases directes sur lignes séparées : bilan global + réponse à l'indication + hypothèses à confirmer si besoin>",
  "",
